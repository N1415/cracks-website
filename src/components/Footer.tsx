      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between mb-12">
          <div className="mb-8 md:mb-0">
            ...
            <p className="font-lato font-thin text-gray-400 max-w-md">
          ...
          <div className="grid grid-cols-2 md:grid-cols-2 gap-8">
            <div>
              ...
              <ul className="space-y-2 font-lato font-thin text-gray-400">
            ...
            <div>
              <h4 className="font-lato font-thin font-semibold text-lg mb-4">Services</h4>
              <ul className="space-y-2 font-lato font-thin text-gray-400">
        ...
        <div className="border-t border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center">
          <div className="font-lato font-thin text-gray-400 text-sm mb-4 md:mb-0">
